...
def _():
    ...
    write_dir = Path("./scans/test_1")      #change the last folder to name the sample being scanned
    write_dir.mkdir(exist_ok=True)
    name_prefix = "vutara_"          #change the "custom" to which microscope took the data
